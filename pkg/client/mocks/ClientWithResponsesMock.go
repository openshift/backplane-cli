...
//
//	mockgen -destination=mocks/ClientWithResponsesMock.go -package=mocks github.com/openshift/backplane-api/pkg/client ClientWithResponsesInterface
//
...
func (m *MockClientWithResponsesInterface) CreateReportWithResponse(ctx context.Context, clusterId string, body Openapi.CreateReportJSONRequestBody, reqEditors ...Openapi.RequestEditorFn) (*Openapi.CreateReportResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, clusterId, body}
	for _, a := range reqEditors {
		varargs = append(varargs, a)
