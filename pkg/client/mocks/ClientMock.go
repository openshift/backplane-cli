...
//
//	mockgen -destination=mocks/ClientMock.go -package=mocks github.com/openshift/backplane-api/pkg/client ClientInterface
//
...
func (m *MockClientInterface) CreateReport(ctx context.Context, clusterId string, body Openapi.CreateReportJSONRequestBody, reqEditors ...Openapi.RequestEditorFn) (*http.Response, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, clusterId, body}
	for _, a := range reqEditors {
		varargs = append(varargs, a)
