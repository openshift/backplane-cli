...
// TODO: Deprecate tunnelling
func TestGetShardName(t *testing.T) {
	tests := []struct {
		inp    string
		expect string
	}{
		{
			inp:    "hive12345.somedomain.com",
			expect: "hive12345",
		},
		{
			inp:    "non.somedomain.com",
			expect: "",
		},
		{
			inp:    "foo.hive123.somedomain.com",
			expect: "hive123",
		},
	}
