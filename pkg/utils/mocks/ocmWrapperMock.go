...
// Source: gitlab.cee.redhat.com/service/backplane-cli/pkg/utils (interfaces: OCMInterface)
...
// GetAllBackplaneShards mocks base method.
func (m *MockOCMInterface) GetAllBackplaneShards() ([]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllBackplaneShards")
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAllBackplaneShards indicates an expected call of GetAllBackplaneShards.
func (mr *MockOCMInterfaceMockRecorder) GetAllBackplaneShards() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllBackplaneShards", reflect.TypeOf((*MockOCMInterface)(nil).GetAllBackplaneShards))
}

// GetBackplaneShard mocks base method.
func (m *MockOCMInterface) GetBackplaneShard(arg0 string) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetBackplaneShard", arg0)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetBackplaneShard indicates an expected call of GetBackplaneShard.
func (mr *MockOCMInterfaceMockRecorder) GetBackplaneShard(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetBackplaneShard", reflect.TypeOf((*MockOCMInterface)(nil).GetBackplaneShard), arg0)
}
