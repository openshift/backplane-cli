FROM registry.access.redhat.com/ubi8/ubi:8.8-1067.1696517599 as base
...
### Build backplane-cli
FROM registry.access.redhat.com/ubi8/ubi:8.8-1067.1696517599 as bp-cli-builder
...
### Build dependencies
FROM registry.access.redhat.com/ubi8/ubi:8.8-1067.1696517599 as dep-builder
