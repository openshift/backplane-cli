FROM registry.access.redhat.com/ubi8/ubi:8.9-1136 as base
...
### Build backplane-cli
FROM registry.access.redhat.com/ubi8/ubi:8.9-1136 as bp-cli-builder
...
### Build dependencies
FROM registry.access.redhat.com/ubi8/ubi:8.9-1136 as dep-builder
