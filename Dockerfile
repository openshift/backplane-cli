FROM registry.access.redhat.com/ubi8/ubi:8.7-1112 as base
...
### Build backplane-cli
FROM registry.access.redhat.com/ubi8/ubi:8.7-1112 as bp-cli-builder
...
### Build dependencies
FROM registry.access.redhat.com/ubi8/ubi:8.7-1112 as dep-builder
