FROM registry.access.redhat.com/ubi8/ubi:8.7-1026 as base
...
### Build backplane-cli
FROM registry.access.redhat.com/ubi8/ubi:8.7-1026 as bp-cli-builder
...
### Build dependencies
FROM registry.access.redhat.com/ubi8/ubi:8.7-1026 as dep-builder
