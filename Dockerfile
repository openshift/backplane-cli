FROM registry.access.redhat.com/ubi8/ubi:8.8-1067.1697633337 as base
...
### Build backplane-cli
FROM registry.access.redhat.com/ubi8/ubi:8.8-1067.1697633337 as bp-cli-builder
...
### Build dependencies
FROM registry.access.redhat.com/ubi8/ubi:8.8-1067.1697633337 as dep-builder
