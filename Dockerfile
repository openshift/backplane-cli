...
### Build backplane-cli
FROM registry.access.redhat.com/ubi9/ubi:9.4-1214.1726694543 as bp-cli-builder
...
### Build dependencies
FROM registry.access.redhat.com/ubi9/ubi:9.4-1214.1726694543 as dep-builder
