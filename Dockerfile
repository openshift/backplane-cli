FROM registry.access.redhat.com/ubi8/ubi:8.8-1032.1692772289 as base
...
### Build backplane-cli
FROM registry.access.redhat.com/ubi8/ubi:8.8-1032.1692772289 as bp-cli-builder
...
### Build dependencies
FROM registry.access.redhat.com/ubi8/ubi:8.8-1032.1692772289 as dep-builder
