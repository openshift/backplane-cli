...
import (
	...
	"gitlab.cee.redhat.com/service/backplane-cli/pkg/client/mocks"
	"gitlab.cee.redhat.com/service/backplane-cli/pkg/utils"
	mocks2 "gitlab.cee.redhat.com/service/backplane-cli/pkg/utils/mocks"
	"io"
...
var _ = Describe("Login command", func() {
	...
	Context("runLogin function", func() {
		It("when running with a simple case should work as expected", func() {
			...
			mockOcmInterface.EXPECT().GetBackplaneShard(trueClusterId).Return(proxyUri, nil).AnyTimes()
